        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Connecting individuals and businesses with sustainable solutions for a greener future.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400">info@ecoconnect.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Stay updated with the latest eco-friendly solutions and sustainability news.
            </p>
